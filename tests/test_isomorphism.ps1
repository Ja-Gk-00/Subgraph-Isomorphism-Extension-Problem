...
foreach ($n in $GraphSizes) {
    ...
    foreach ($seed in $Seeds) {
        ...
        & $GeneratorPath $n $n --isomorphic --output $filepath --density 0.6 --seed $seed | Out-Null
    ...
    "Naive,$n,$avgNaive" | Out-File $ResultsFile -Append -Encoding utf8
    "Ullmann,$n,$avgUllmann" | Out-File $ResultsFile -Append -Encoding utf8
